...
exports.initialize = function(port, config, cb, ecb) {
	...
	DreamSchema.add({
		...
		sentiment		: { 
			...
			comparative	: { type: Number, default: 0.0 },
			magnitude	: { type: Number, default: 0.0 }
		},
		sleep_type		: String,
		dream_type		: String,
		content_recent	: Boolean,
		content_upcoming	: Boolean,
		content_stressful	: Boolean,
		content_surreal	: Boolean,
		content_scary	: Boolean,
		content_romantic	: Boolean,
		content_sexual	: Boolean
	});
