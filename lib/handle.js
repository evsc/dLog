...
exports.initialize = function() {
	...
	all = function(db,tag,character,sort,response) {
		util.log("POST 'all'");
		    ...
		    function(err,docs) {
			  ...
			  if(docs) {
			  	docs.forEach( function (d) {
			  		...
			  		var stripDream = { _id: d._id, title: d.title, date: d.date, start: d.start, tag_cnt: d.tags.length, word_cnt: spaceCount, char_cnt: d.characters.length, sentiment: d.sentiment };
			...
			if(json.id) {
				...
				db.Dream.findOne( { _id: json.id }, function(err, doc) {
					...
					if(doc) {
						...
						doc.content_recent = json.content_recent;
						doc.content_upcoming = json.content_upcoming;
						doc.content_stressful = json.content_stressful;
						doc.content_surreal = json.content_surreal;
						doc.content_scary = json.content_scary;
						doc.content_romantic = json.content_rcontent_romanticecent;
						doc.content_sexual = json.content_sexual;
